...
echo ""
LOGIN_URL="$KEYCLOAK_URL/realms/$REALM/protocol/openid-connect/auth?client_id=$CLIENT_ID&response_type=code&redirect_uri=$REDIRECT_URI&scope=openid%20profile%20email&state=abc123"
echo "URL: $LOGIN_URL"
echo ""
echo "Login with:"
echo "  Username: $USERNAME"
